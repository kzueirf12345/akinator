...
#ifndef TREE_INOUT_ELEM_CODE
#define TREE_INOUT_ELEM_CODE "%lX"
#endif /*TREE_INOUT_ELEM_CODE*/
#ifndef TREE_INOUT_ELEM_T
#define TREE_INOUT_ELEM_T uint64_t
#endif /*TREE_INOUT_ELEM_T*/
                   ...
                   const size_t str_size)
{
    ...
    char temp_str[TREE_INOUT_ELEM_SIZE  * 4] = {};
    for (size_t offset = 0; offset < size; 
         offset += (size - offset >= TREE_INOUT_ELEM_SIZE  ? TREE_INOUT_ELEM_SIZE  : sizeof(uint8_t)))
    {
        if (size - offset >= TREE_INOUT_ELEM_SIZE )
        {
            if (snprintf(temp_str, TREE_INOUT_ELEM_SIZE * 4, TREE_INOUT_ELEM_CODE,
                         *(const TREE_INOUT_ELEM_T*)((const char*)data + offset)) <= 0)
            {
        ...
        {
            if (snprintf(temp_str, sizeof(uint8_t) * 4, TREE_INOUT_ELEM_CODE, 
